...
const DEFAULT_STRAPI_URL = process.env.STRAPI_API_URL ?? "http://localhost:1337"
...
export const getStrapiClient = (): StrapiClient => {
  ...
  return { fetch: fetchFromStrapi, resolveMedia: (url?: string | null) => resolveStrapiMedia(url, baseUrl), baseUrl, apiToken }
}
