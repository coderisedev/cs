...
import { getCountriesByGeographicRegion, getRegionForCountry, REGIONS, COUNTRY_NAMES, getCountryFlag } from "@/lib/config/regions"
...
export function CountrySelector({ currentCountry }: CountrySelectorProps) {
  ...
  const geographicRegions = getCountriesByGeographicRegion()
  const currentCurrency = REGIONS[currentRegionCode].currency
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span className="text-xs text-foreground-muted">({currentCurrency})</span>
