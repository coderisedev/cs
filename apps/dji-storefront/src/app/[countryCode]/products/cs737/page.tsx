...
import { CTASection } from "@/components/products/cs737/CTASection"
    ...
    return (
        <div className="min-h-screen bg-black text-white selection:bg-[#0071e3]/30">
            ...
            <main>
                ...
                {/* Feature Sections - Apple-style alternating layouts */}
                <div id="features">
                    <FeatureSection
                    ...
                    <FeatureSection
                        ...
                        imageSrc="https://images.unsplash.com/photo-1581092918056-0c4c3acd3789?q=80&w=2670&auto=format&fit=crop"
                    ...
                    <FeatureSection
                        ...
                        imageSrc="https://images.unsplash.com/photo-1525266383472-872f641a84f6?q=80&w=2670&auto=format&fit=crop"
