...
const DiscountCode: React.FC<DiscountCodeProps> = ({ cart }) => {
  ...
  return (
    <div className="w-full rounded-3xl border border-border-base bg-surface-primary p-6 flex flex-col">
              ...
              {promotions.map((promotion) => {
                return (
                  ...
                  >
                    ...
                    {!promotion.is_automatic && (
                      <button
                        className="flex items-center text-foreground-muted hover:text-foreground-base"
                        onClick={() => {
                          if (!promotion.code) {
                            return
                          }
