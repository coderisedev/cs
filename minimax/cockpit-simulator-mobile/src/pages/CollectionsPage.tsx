      ...
      <div className="border-b border-border-primary bg-background-secondary">
        <div className="container mx-auto px-4 lg:px-12 py-4">
          <nav className="flex items-center space-x-2 text-sm text-foreground-secondary">
            ...
            <span>/</span>
            <span className="text-foreground-primary">Collections</span>
          </nav>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4 lg:px-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {collections.map((collection) => (
              ...
              >
                <div className="relative overflow-hidden rounded-xl bg-background-elevated aspect-[4/3] mb-4 shadow-sm group-hover:shadow-lg transition-all duration-300">
                  <img
                ...
                <div className="flex items-center justify-between">
                  ...
                  <ArrowRight className="h-5 w-5 text-foreground-muted group-hover:text-primary group-hover:translate-x-1 transition-all duration-200" />
                </div>
              </Link>
            ))}
          </div>
      ...
      <section className="py-12 sm:py-16 bg-background-elevated">
        <div className="container mx-auto px-4 lg:px-12">
          <div className="text-center mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold mb-4 text-foreground-primary">Why Shop by Collection?</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold mb-2 text-foreground-primary">Complete Systems</h3>
              <p className="text-sm text-foreground-secondary">
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold mb-2 text-foreground-primary">Modular Design</h3>
              <p className="text-sm text-foreground-secondary">
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold mb-2 text-foreground-primary">Expert Support</h3>
              <p className="text-sm text-foreground-secondary">
